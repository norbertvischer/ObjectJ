...
public class Clipboard implements PlugIn, Transferable {
	...
	Image getImageFromPictStream(InputStream is) {
		try {
			...
			Method m = c.getMethod("isInitialized", (Class) null);//9.1.2009
			Boolean b= (Boolean)m.invoke(null, (Object) null);//9.1.2009
			if (b.booleanValue() == false) {
				m= c.getMethod("open",  (Class) null);//9.1.2009
				m.invoke(null, (Object) null);//9.1.2009
			}
			...
			m = c.getMethod("getNaturalBounds", (Class) null);//9.1.2009
			Object rect= m.invoke(importer, (Object) null);//9.1.2009
			...
			m = rect.getClass().getMethod("getWidth", (Class) null);//9.1.2009
			Integer width= (Integer)m.invoke(rect, (Object) null);//9.1.2009
			m = rect.getClass().getMethod("getHeight", (Class) null);//9.1.2009
			Integer height= (Integer)m.invoke(rect, (Object) null);//9.1.2009
