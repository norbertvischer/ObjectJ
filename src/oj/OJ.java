...
public class OJ {
    ...
    public final static int build = 588;
    public final static String releaseVersion = "1.05i1";//follow Wayne's numbering
    public final static String buildDate = "01-Apr-2021";
