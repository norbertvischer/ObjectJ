...
public class OJ {
    ...
    public final static int build = 504;//dropbox problems
    public final static String releaseVersion = "1.03v4";//do not follow Wayne
    public final static String buildDate = "15-oct-2015 21:30";
