...
public class OJ {
    ...
    public final static int build = 575;
    public final static String releaseVersion = "1.05g06";//follow Wayne's numbering
    public final static String buildDate = "01-feb-2021";
