...
public class OJ {
    ...
    public final static int build = 505;//dropbox problems
    public final static String releaseVersion = "1.03v5";//do not follow Wayne
    public final static String buildDate = "17-oct-2015 00:26";
