...
public class OJ {
    ...
    public final static int build = 515;//dropbox problems
    public final static String releaseVersion = "1.04d";//do not follow Wayne
    public final static String buildDate = "23-dec-2017 22:18";
