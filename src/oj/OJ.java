...
public class OJ {
    ...
    public final static int build = 599;
    public final static String releaseVersion = "1.05j1";//follow Wayne's numbering
    public final static String buildDate = "14-Apr-2021";
