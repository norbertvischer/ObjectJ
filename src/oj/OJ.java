...
public class OJ {
    ...
    public final static int build = 591;
    public final static String releaseVersion = "1.05i4";//follow Wayne's numbering
    public final static String buildDate = "07-Apr-2021";
