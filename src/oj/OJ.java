...
public class OJ {
    ...
    public final static int build = 606;
    public final static String releaseVersion = "1.05m";//follow Wayne's numbering
    public final static String buildDate = "14-Feb-2022";
