...
public class OJ {
    ...
    public final static int build = 577;
    public final static String releaseVersion = "1.05g";//follow Wayne's numbering
    public final static String buildDate = "04-feb-2021";
