...
public class OJ {
    ...
    public final static int build = 572;
    public final static String releaseVersion = "1.05g04";//follow Wayne's numbering
    public final static String buildDate = "29-jan-2021";
