...
public class OJ {
    ...
    public final static int build = 600;
    public final static String releaseVersion = "1.05j2";//follow Wayne's numbering
    public final static String buildDate = "23-Apr-2021";
