...
public class OJ {
    ...
    public final static int build = 522;
    public final static String releaseVersion = "1.04j";//do not follow Wayne
    public final static String buildDate = "25-jun-2018 23:13";
