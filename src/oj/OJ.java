...
public class OJ {
    ...
    public final static int build = 596;
    public final static String releaseVersion = "1.05i6";//follow Wayne's numbering
    public final static String buildDate = "08-Apr-2021";
