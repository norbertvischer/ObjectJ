...
public class OJ {
    ...
    public final static int build = 581;
    public final static String releaseVersion = "1.05h4";//follow Wayne's numbering
    public final static String buildDate = "29-Mar-2021";
