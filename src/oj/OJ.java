...
public class OJ {
    ...
    public final static int build = 584;
    public final static String releaseVersion = "1.05h5";//follow Wayne's numbering
    public final static String buildDate = "31-Mar-2021";
