...
public class OJ {
    ...
    public final static int build = 520;
    public final static String releaseVersion = "1.04h";//do not follow Wayne
    public final static String buildDate = "29-may-2018 23:24";
