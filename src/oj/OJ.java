...
public class OJ {
    ...
    public final static int build = 487;
    public final static String releaseVersion = "1.03q4";//do not follow Wayne
    public final static String buildDate = "11-nov-2014 01:28";
