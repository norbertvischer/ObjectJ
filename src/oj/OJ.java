...
public class OJ {
    ...
    public final static int build = 488;
    public final static String releaseVersion = "1.03q5";//do not follow Wayne
    public final static String buildDate = "18-nov-2014 13:48";
