...
public class OJ {
    ...
    public final static int build = 509;//dropbox problems
    public final static String releaseVersion = "1.03z";//do not follow Wayne
    public final static String buildDate = "27-jan-2017 21:04";
