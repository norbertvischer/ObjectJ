...
public class OJ {
    ...
    public final static int build = 494;
    public final static String releaseVersion = "1.03t2";//do not follow Wayne
    public final static String buildDate = "09-apr-2015 22:33";
