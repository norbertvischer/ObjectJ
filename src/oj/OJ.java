...
public class OJ {
    ...
    public final static int build = 514;//dropbox problems
    public final static String releaseVersion = "1.04c";//do not follow Wayne
    public final static String buildDate = "05-jun-2017 23:20";
