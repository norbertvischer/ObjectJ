...
public class OJ {
    ...
    public final static int build = 495;
    public final static String releaseVersion = "1.03t3";//do not follow Wayne
    public final static String buildDate = "12-apr-2015 18:00";
