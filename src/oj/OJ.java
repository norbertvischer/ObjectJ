...
public class OJ {
    ...
    public final static int build = 579;
    public final static String releaseVersion = "1.05h2";//follow Wayne's numbering
    public final static String buildDate = "10-Mar-2021";
