...
public class OJ {
    ...
    public final static int build = 486;
    public final static String releaseVersion = "1.03q3";//do not follow Wayne
    public final static String buildDate = "13-oct-2014 00:08";
