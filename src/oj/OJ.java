...
public class OJ {
    ...
    public final static int build = 574;
    public final static String releaseVersion = "1.05g05";//follow Wayne's numbering
    public final static String buildDate = "30-jan-2021";
