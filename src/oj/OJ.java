...
public class OJ {
    ...
    public final static int build = 512;//dropbox problems
    public final static String releaseVersion = "1.04a";//do not follow Wayne
    public final static String buildDate = "25-feb-2017 23:16";
