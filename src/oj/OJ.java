...
public class OJ {
    ...
    public final static int build = 578;
    public final static String releaseVersion = "1.05h1";//follow Wayne's numbering
    public final static String buildDate = "08-Mar-2021";
