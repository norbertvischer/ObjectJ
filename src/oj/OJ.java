...
public class OJ {
    ...
    public final static int build = 502;//dropbox problems
    public final static String releaseVersion = "1.03v3";//do not follow Wayne
    public final static String buildDate = "04-oct-2015 06:38";
