...
public class OJ {
    ...
    public final static int build = 493;
    public final static String releaseVersion = "1.03t1";//do not follow Wayne
    public final static String buildDate = "23-jan-2015 01:48";
