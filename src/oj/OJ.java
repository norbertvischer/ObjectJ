...
public class OJ {
    ...
    public final static int build = 589;
    public final static String releaseVersion = "1.05i2";//follow Wayne's numbering
    public final static String buildDate = "05-Apr-2021";
