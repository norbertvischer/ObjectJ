...
public abstract class YtemOJ extends BaseAdapterOJ {
	...
	protected String info;//21.1.2019
	...
	public String getInfo() {//21.1.2019
		if (info == null) {
			return "";
		}
		return info;
	...
	public void setInfo(String s) {//21.1.2019
		info = s;
	}
...
//    }
	...
	/**
	 * @return ytem's x positions with magnification and offset for screen
	 * display
	 */
	...
	/**
	 * @return ytem's y positions with magnification and offset for screen
	 * display
	 */
