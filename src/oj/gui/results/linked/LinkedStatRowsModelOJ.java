/*
 * LinkedHeaderTableModelOJ.java
 * fully documented
 *
 * Handles the non-scrolling 0..7 rows of linked headertable that contains statistic values
 */
 ...
 */
public class LinkedStatRowsModelOJ extends AbstractTableModel {

    public static int EMPTY_COLUMNS_COUNT = 8;

    public LinkedStatRowsModelOJ() {
    }
