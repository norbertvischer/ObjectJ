...
//							}
    ...
    private void initComponents() {
        ...
        mncAddToPlot = new javax.swing.JMenuItem();
        ...
        mncAddToPlot.setText("Add to Plot...");
        mncAddToPlot.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mncAddToPlotActionPerformed(evt);
            }
        });
        popUpColumn.add(mncAddToPlot);
...
IJ.beep();//13.5.2019
	...
	private void plotFromOjResult(java.awt.event.ActionEvent evt, boolean doAdd) {
		...
		for (int col = 0; col < columns.getLinkedColumnsCount(); col++) {
			...
			if (!column.getColumnDef().isTextMode() && !column.getColumnDef().isUnlinked()) {
    ...
    private javax.swing.JMenuItem mncAddToPlot;
