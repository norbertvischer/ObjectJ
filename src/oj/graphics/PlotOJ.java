...
public class PlotOJ {
	...
	public void makeHistoFromColumn2(ColumnOJ column) {
		...
		gd.addNumericField("Bin width", Double.NaN, 2, 6, "(empty=automatic)");
		gd.showDialog();
		...
		if (len > 1) {
			...
			double var = (double) ((total2 - (total * total / len)) / (len - 1));
	 ...
	 */
	public void makeHistoFromColumnOld(ColumnOJ column) {
