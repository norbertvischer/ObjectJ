...
public class MacroSetOJ //extends MacroBaseOJ
	...
	//public static transient Thread lastThread;//5.2.2021
	public MacroSetOJ() {
		name = "";
		content = "";
		description = "";
	...
	public void runMacro(String macroName) {
		...
		if (index >= 0) {
			MacroRunner mr = new MacroRunner(macroProgram.getProgram(), macroProgram.getMacroStarts(macroName), macroName, (String) null);//9.1.2009
			//Thread lastThread = mr.getThread();
			//int dummy = 0;
		}
	}
